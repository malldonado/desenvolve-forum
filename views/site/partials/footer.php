...
<footer class="footer pt-4 my-md-5 pt-md-5 border-top">
    <div class="row">
        <div class="col-12 col-md">
            <img class="fotter-logo" class="mb-2" src="../../resources/img/footer-logo.png" alt="">
    ...
    <small class="footer-text d-block mb-3">Todos os direitos reservados a Desenvouve © 2020</small>
</footer>
