<?php 
      require_once("views/partials/header.html");
?>
...
<?php 
      require_once("views/partials/start-pagination.php");
      require_once("views/partials/login-modal.php");
      require_once("views/partials/register-modal.php");
      require_once("views/partials/confirmation-modal.php");
